 ...
 */
@Stateless
@Path("es.uva.petadopt.model.solicitudadopcion")
public class SolicitudadopcionFacadeREST extends AbstractFacade<Solicitudadopcion> {
    ...
    public void create(Solicitudadopcion entity) {
        super.create(entity);
    }
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Integer id, Solicitudadopcion entity) {
        super.edit(entity);
    }
